                    ...
                    <MDBCol size='md my-5'>
                        <MDBCard>
                            ...
                            <MDBCardBody className="cardbody">
                                ...
                                <MDBCardText>
                                Quen é um sinal mágico simples usado por bruxos. Quando lançado, forma um campo de proteção em torno do bruxo que o protege de ondas sônicas e ataques similares, mas não dos golpes físicos. Sua forma expandida pode proteger de uma gama maior de ações ofensivas.<br/><br/>
                                <q><em>Este sinal pode ser a diferença entre a vida e a morte. Habilidade básica de Quen é cobrir Geralt com um escudo de que absorve uma quantidade limitada de danos. Geralmente isso significa um único golpe da maioria dos inimigos de mesmo nível, mas isso não significa que Quen não é útil. Se você estiver usando Light Armor, sua regeneração de Stamina pode ser tão rápida que você pode lançar Quen várias vezes em uma luta para mantê-lo seguro contra danos. Investir em Quen pode torná-lo capaz de sustentar vários hits antes do efeito se desfazer. Isso aumenta com intensidade do sinal.</em></q><br/>
