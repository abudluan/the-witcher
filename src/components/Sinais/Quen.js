                    ...
                    <MDBCol size='md my-5'>
                        <MDBCard>
                            ...
                            <MDBCardBody className="cardbody">
                                ...
                                <MDBCardText>
                                 Quando lançado, <span className="text-warning">Quen</span> forma um campo de proteção em torno do bruxo que o protege de ondas sônicas e ataques similares, mas não dos golpes físicos. <span className="text-warning">Quen</span> funciona apenas por um momento e amortece um único ataque poderoso e permanece ativo até que seja destruído ou dissípado.<br/><br/>
