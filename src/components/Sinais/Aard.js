                    ...
                    <MDBCol size='md my-5'>
                        <MDBCard>
                            ...
                            <MDBCardBody className="cardbody">
                                ...
                                <MDBCardText>
                                    <span className="text-primary">Aard</span> é um simples sinal mágico usado por bruxos. Trata-se de um um impulso telecinético que pode atordoar, empurrar, derrubar ou desarmar os adversários, bem como remover obstáculos e outros objetos.<br /><br />
